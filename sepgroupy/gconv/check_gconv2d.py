...
from sepgroupy.gconv.splitgconv2d import P4ConvP4, P4ConvZ2, P4MConvP4M, P4MConvZ2


def test_p4_net_equivariance():
    import sepgroupy.garray.C4_array as c4a
    from sepgroupy.gfunc import P4FuncArray, Z2FuncArray
...
def test_p4m_net_equivariance():
    ...
    from sepgroupy.gfunc import P4MFuncArray, Z2FuncArray
...
def test_gp4_net_equivariance():
    import sepgroupy.garray.C4_array as c4a
    from sepgroupy.gconv.g_splitgconv2d import gP4ConvP4, gP4ConvZ2
    from sepgroupy.gfunc import P4FuncArray, Z2FuncArray
...
def test_gp4m_net_equivariance():
    import sepgroupy.garray.D4_array as d4a
    from sepgroupy.gconv.g_splitgconv2d import gP4MConvP4M, gP4MConvZ2
    from sepgroupy.gfunc import P4MFuncArray, Z2FuncArray
...
def test_gcp4_net_equivariance():
    import sepgroupy.garray.C4_array as c4a
    from sepgroupy.gconv.gc_splitgconv2d import gcP4ConvP4, gcP4ConvZ2
    from sepgroupy.gfunc import P4FuncArray, Z2FuncArray
...
def test_gcp4m_net_equivariance():
    import sepgroupy.garray.D4_array as d4a
    from sepgroupy.gconv.gc_splitgconv2d import gcP4MConvP4M, gcP4MConvZ2
    from sepgroupy.gfunc import P4MFuncArray, Z2FuncArray
...
def test_g_z2_conv_equivariance():
    import sepgroupy.garray.C4_array as c4a
    import sepgroupy.garray.D4_array as d4a
    from sepgroupy.gfunc import P4FuncArray, P4MFuncArray, Z2FuncArray
