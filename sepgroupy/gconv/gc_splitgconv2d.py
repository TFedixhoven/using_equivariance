    ...
    def __init__(
        ...
        if self.input_stabilizer_size == 1:
            ...
            self.depthwise_weight = Parameter(
                torch.Tensor(out_channels, 1, 1, *kernel_size)
            )
    ...
    def forward(self, input):
        ...
        if self.input_stabilizer_size == 1:
            ...
            tw_depthwise = trans_filter_d(
                self.depthwise_weight, self.input_stabilizer_size
            )
...
class gcP4ConvZ2(SplitGConv2D):
    ...
    def __init__(self, *args, **kwargs):
        super(gcP4ConvZ2, self).__init__(
...
class gcP4ConvP4(SplitGConv2D):
    def __init__(self, *args, **kwargs):
        super(gcP4ConvP4, self).__init__(
...
class gcP4MConvZ2(SplitGConv2D):
    ...
    def __init__(self, *args, **kwargs):
        super(gcP4MConvZ2, self).__init__(
...
class gcP4MConvP4M(SplitGConv2D):
    def __init__(self, *args, **kwargs):
        super(gcP4MConvP4M, self).__init__(
