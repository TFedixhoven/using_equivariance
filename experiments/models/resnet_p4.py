...
class CustomResNet(ResNet):
    def __init__(
        ...
        conv_layer = {None: P4ConvP4, "g": gP4ConvP4, "gc": gcP4ConvP4}
        ...
        if groupcosetmaxpool:
            ...
            self.fc = nn.Linear(channels[-1] * block.expansion * 4, num_classes)
...
if __name__ == "__main__":
    ...
    m = P4ResNet18(num_classes=10)
    summary(m, (1, 3, 32, 32))

    m = gcP4ResNet18(num_classes=10)
    summary(m, (1, 3, 32, 32))

    m = P4ResNet44(num_classes=10)
    summary(m, (1, 3, 32, 32))

    m = gcP4ResNet44(num_classes=10)
    summary(m, (1, 3, 32, 32))
